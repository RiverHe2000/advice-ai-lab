...
Train 495 / test 165 documents; calibration `sigmoid`; 1.0 ms per document.
...
|---:|---:|---:|---:|---:|
| 0.05 | 0.982 [0.958, 1.000] | 0.982 [0.954, 1.000] | 0.081 | 0.036 |
| 0.10 | 0.958 [0.921, 0.988] | 0.959 [0.923, 0.984] | 0.127 | 0.103 |

## Zero-shot LLM baseline (fake)

| Metric | Value |
|---|---:|
| Accuracy | 0.818 [0.758, 0.873] |
| Missing (unparseable) | 4 |
| JSON repairs | 64 |
| Zero-shot wins / ML wins | 0 / 30 |
| McNemar p | 0.000 |
